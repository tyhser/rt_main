...
#else
	uint8_t cmd[] = "/1n3aM3j16m120L120h50V16000Z60000V64000aM1j16m120L100h20V16000Z120000V64000aM2j16m120L110h20V16000Z100000V64000aM4j16m125L900V30000Z65000R\r";
#endif
	uint8_t recv[128] = {0};
	cmd[1] = get_hex_ch(station_addr);
	pmc_send_then_recv(cmd, strlen((char *)cmd), recv, 128);
